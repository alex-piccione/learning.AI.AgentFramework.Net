...
| Model Name | Model ID | Cost (per 1M tokens in/out) | Capabilities | Notes |
|---|---|---|---|---|
...
| Llama 4 Maverick 17B 128E FP8 | `meta/llama-4-maverick-17b-128e-instruct-fp8` | 0.25 / 1.00 | tools, streaming, agents | Multimodal, 1M context |
